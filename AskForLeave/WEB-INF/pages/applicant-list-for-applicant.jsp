...
<!--<link rel="stylesheet" href="${pageContext.request.contextPath}/${pageContext.request.contextPath}/${pageContext.request.contextPath}/source/plugins/timepicker/bootstrap-timepicker.min.css">-->
...
<!-- bootstrap color picker -->
<!-- bootstrap time picker -->
<!--<script src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/${pageContext.request.contextPath}/source/plugins/timepicker/bootstrap-timepicker.min.js"></script>-->
<!-- Bootstrap WYSIHTML5 -->
<!--bootstrap-markdown-->
<!-- CK Editor -->
<!-- InputMask -->
...
<body class="hold-transition skin-purple sidebar-mini">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc">请假理由</th>
										<th class="sorting_desc">请假开始时间</th>
										<th class="sorting_desc">请假结束时间</th>
										<th class="sorting_asc sorting_asc_disabled">请假类型</th>
										<th class="sorting_desc">申请人</th>
										<th class="sorting_desc">操作人</th>
										<th class="sorting_desc">意见</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${info.list}" var="applicant">
										<tr>
											<td><input name="ids" type="checkbox"></td>
											<td>${applicant.reason}</td>
											<td>${applicant.leaveTimeStr}</td>
											<td>${applicant.backTimeStr}</td>
											<td>${applicant.type}</td>
											<td>${applicant.applicant}</td>
											<td>${applicant.operater}</td>
											<td>${applicant.OPTIONS}</td>
										</tr>
									</c:forEach>
								</tbody>
								<!--
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								总共${info.pages} 页，共 ${info.size}条数据。 默认每页 5 条
							</div>
						</div>

						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/information/getInformations?account=<security:authentication property="principal.username"/>&page=1&size=${info.pageSize}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/information/getInformations?account=<security:authentication property="principal.username"/>&page=${info.pageNum-1}&size=${info.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${info.pages}" var="page">
									<li><a href="${pageContext.request.contextPath}/information/getInformations?account=<security:authentication property="principal.username"/>&page=${page}&size=${info.pageSize}">${page}</a></li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/information/getInformations?account=<security:authentication property="principal.username"/>&page=${info.pageNum+1}&size=${info.pageSize}">下一页</a></li>
								<li>
								<li><a href="${pageContext.request.contextPath}/information/getInformations?account=<security:authentication property="principal.username"/>&page=${info.pages}&size=${info.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
	...
	<script
		src="${pageContext.request.contextPath}/source/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.js"></script>
	<script
		src="${pageContext.request.contextPath}/source/plugins/bootstrap-datetimepicker/locales/bootstrap-datetimepicker.zh-CN.js"></script>
	<script>
